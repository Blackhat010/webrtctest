...
void Parser::ParseArgs(int argc, char *argv[], Args &args) {
    ...
    opts.add_options()
        ...
        ("v4l2-format", bpo::value<std::string>(&args.v4l2_format)->default_value("yuv420"),
            "The input format (`i420`, `mjpeg`, `h264`, `yuv420`) of the V4L2 camera.")
        ...
        ("sharpness", bpo::value<float>(&args.sharpness)->default_value(2.0f),
            "Adjust the sharpness of the libcamera output in range 0.0 to 15.99")
        ("contrast", bpo::value<float>(&args.contrast)->default_value(2.0f),
            "Adjust the contrast of the libcamera output in range 0.0 to 15.99")
        ("brightness", bpo::value<float>(&args.brightness)->default_value(0.1f),
            "Adjust the brightness of the libcamera output in range -1.0 to 1.0")
        ("saturation", bpo::value<float>(&args.saturation)->default_value(2.0f),
        ...
        ("denoise", bpo::value<std::string>(&args.denoise)->default_value("cdn_hq"),
        ...
        ("jpeg-quality", bpo::value<int>(&args.jpeg_quality)->default_value(90),
